...
" compiling
" ============
autocmd Filetype tex nnoremap <F5> :w<CR> :!pdflatex -synctex=1 -interaction=nonstopmode %:t:r <CR><CR>
autocmd Filetype tex nnoremap <m-F5> :w<CR> :!pdflatex -synctex=1 -interaction=nonstopmode %:t:r <CR>
